            ...
            if( tmplist.Count > 0 ) {
                ...
                foreach (Mova mv in lima) {
                    if (tpp.ContraMov(mv.Shorto, 1)) {
                        ...
                        throw new myClasterException(string.Format("Vario-Constructor(varel), Плохая мова  --{0}--{1}--", tpp.NumberMove, mv.Shorto));
                        }
                    }
                }
...
#region--------------------------Свойства объекта-----------------------------------------
        ...
        public pozo BegoPo { get { return bego; } }
...
#endregion-----------------------------ПЕРВИЧНЫЙ КЛАСС--Vario------------------------

#region--------------------------------ДРУГОЙ КЛАСС--VarQvant------------------------
    /// <summary>
...
#endregion-----------------------------ДРУГОЙ КЛАСС--VarQvant------------------------    
